...
If you want more fine-grained options, have a look at the wide variety of packages out there that allow you to craft your call step by step - ellmar, tidyllm, tidyprompt, ollamar are all more powerful. I wrote this package for users who are not experienced with R and overwhelmed by those packages.

This package aims to give you one function for the use cases I looked at (text annotation) and is targeted at users with little experience in coding R and more experience in manual annotation. My aim is to make the process as close to manual annotation as possible so you can apply existing knowledge.

The name, as you might have noticed, is a pun on the name of the god of wine. I did whine a lot while writing the code, because I am not a good coder either. Wine might have been involved as well.
...
[Annotation routine](vignettes/routine.md) is a vignette that explains how to write your own annotation instructions from scratch and improve them until you're satisfied with the results.

[Alternate modes](vignettes/modes.md) is a vignette that explains how to use bacchuss with a litellm backend and how to use json mode.
